return {
  ...
  event = {
    ...
    "BufReadPre ~/Documents/cathy-notes/*.md",
    "BufNewFile ~/Documents/cathy-notes/*.md",
  },
  keys = {
    ...
    { "<leader>ol", "<cmd>ObsidianLink<cr>", desc = "Link selection to note" },
